...
@measure_energy_to_csv(n=get_measurement_runs("reverse_complement"), csv_filename="reverse_complement_pypy")
def run_energy_benchmark(dna_sequence: str) -> None:
    reverse_complement(dna_sequence)

@measure_time_to_csv(n=get_measurement_runs("reverse_complement"), csv_filename="reverse_complement_pypy")
