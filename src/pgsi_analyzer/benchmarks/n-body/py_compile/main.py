...
@measure_time_to_csv(n=get_measurement_runs("nbody"), csv_filename="nbody_py_compile")
...
@measure_energy_to_csv(n=get_measurement_runs("nbody"), csv_filename="nbody_py_compile")
