...
@measure_energy_to_csv(n=get_measurement_runs("binary-trees"), csv_filename="binary_trees_pycompile")
def run_energy_benchmark(n: int) -> None:
    main(n)

@measure_time_to_csv(n=get_measurement_runs("binary-trees"), csv_filename="binary_trees_pycompile")
