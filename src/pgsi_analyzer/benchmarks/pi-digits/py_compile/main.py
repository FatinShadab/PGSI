...
@measure_energy_to_csv(n=get_measurement_runs("pi_digits"), csv_filename="pi_digits_pycompile")
...
@measure_time_to_csv(n=get_measurement_runs("pi_digits"), csv_filename="pi_digits_pycompile")
