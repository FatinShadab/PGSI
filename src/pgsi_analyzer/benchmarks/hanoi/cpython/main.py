...
@measure_energy_to_csv(n=get_measurement_runs("hanoi"), csv_filename="hanoi_cpython")
...
@measure_time_to_csv(n=get_measurement_runs("hanoi"), csv_filename="hanoi_cpython")
