...
@measure_energy_to_csv(n=get_measurement_runs("strassen"), csv_filename="strassen_pycompile")
...
@measure_time_to_csv(n=get_measurement_runs("strassen"), csv_filename="strassen_pycompile")
