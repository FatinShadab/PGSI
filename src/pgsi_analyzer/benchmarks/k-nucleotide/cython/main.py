...
@measure_energy_to_csv(n=get_measurement_runs("K_Nucleotide"), csv_filename="K_Nucleotide_cython")
def run_energy_benchmark() -> None:
    main()
    time.sleep(0.01)

@measure_time_to_csv(n=get_measurement_runs("K_Nucleotide"), csv_filename="K_Nucleotide_cython")
