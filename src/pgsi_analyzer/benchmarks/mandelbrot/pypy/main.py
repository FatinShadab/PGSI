...
@measure_energy_to_csv(n=get_measurement_runs("mandelbrot"), csv_filename="mandelbrot_pypy")
...
@measure_time_to_csv(n=get_measurement_runs("mandelbrot"), csv_filename="mandelbrot_pypy")
