...
@measure_energy_to_csv(n=get_measurement_runs("fannkuch_redux"), csv_filename="fannkuch_redux_cpython")
def run_energy_benchmark(n: int) -> None:
    driver(n)


@measure_time_to_csv(n=get_measurement_runs("fannkuch_redux"), csv_filename="fannkuch_redux_cpython")
